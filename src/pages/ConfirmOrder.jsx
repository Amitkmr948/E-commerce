...
const OrderConfirmation = () => {
  ...
  return (
    <section
      className="OrderConfirmation pt-10 bg-slate-300 text-richblack-50"
      id="OrderConfirmation"
    >
      <div className="container mx-auto px-4 bg-blue-600 rounded-3xl shadow-xl shadow-richblack-900 mb-16">
        {/* Section Title */}
        <div className="section_title text-center mb-10 fade-in ">
          <h1 className="text-3xl lg:text-5xl font-semibold text-blue-200 slide-in-top">
            Order Confirmation
          </h1>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="image-section flex justify-center items-center">
            <img
              src="https://img.freepik.com/premium-vector/man-suit-with-sign-that-says-thank-you_926199-4116461.jpg?size=626&ext=jpg&ga=GA1.1.1222639884.1727459593&semt=ais_hybrid"
              alt="Order Confirmation Illustration"
              className="rounded-lg shadow-lg shadow-sky-100 w-full h-[700px] object-cover"
            />
          </div>
        </div>
      </div>
