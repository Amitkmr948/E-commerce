...
import ContactFormSection from "../components/Core/About/ContactFrom";
    ...
    return (
        <div className="text-blue-50">
            ...
            <section className="bg-gray-900 relative overflow-hidden">
                <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center text-center text-teal-100">
                    {/* Hero Header */}
                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
                        ...
                        <div className="relative animate-zoomIn ">
                            <img
                                src={OurStoryImage}
                                alt="Our Story"
                                className=" hover:shadow-glow hover:scale-105 transition-all duration-500 h-[500px] w-[550px] m-5 shadow-2xl shadow-sky-400 rounded-xl"
                            />
                        </div>
                    </div>
                </div>
            ...
            <section className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white animate-fadeIn">
                <ContactFormSection />
            </section>
