...
const Home = () => {
  ...
  return (
    <div className="bg-slate-100 text-gray-800 h-full">
      {/* Video Section */}
      <div className="flex flex-row justify-center items-center pt-10 space-x-8">
        {/* Text Section */}
        <div className="flex flex-col">
          <h2 className="text-5xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-sky-100 to-yellow-300">
            Welcome to Our Store
          </h2>
          <div className="text-lg text-gray-800 mb-8 max-w-lg leading-relaxed">
            <p className="text-gray-800">
              Explore top-quality products across categories like electronics, fashion, home essentials, and beauty.
            </p>
            <div className="mt-4">
              <TypeAnimation
                sequence={[
        ...
        {/* Video Section */}
        <div className="shadow-[10px_-5px_50px_-5px] shadow-teal-100 w-[600px] rounded-3xl">
          <video
      ...
      <div className="border-dashed border-b-4 border-blue-300 py-5 w-11/12 mx-auto"></div>

      {/* Hero Section with Image Slider */}
      <div className="h-[600px] w-[920px] bg-teal-300 flex flex-col justify-between items-center mx-auto my-20 rounded-3xl shadow-[10px_-5px_50px_-5px] shadow-sky-200">
        <h2 className="text-3xl font-bold mt-6 text-white">Our Featured Categories</h2>
        <p className="text-md text-gray-100 mb-6">
          Scroll through our featured categories to find exactly what you're looking for.
        </p>
        <div className="banner relative mt-1 p-1 mb-10">
          ...
          <button
            className="absolute top-[50%] left-4 w-10 text-2xl p-2 bg-sky-400 text-white rounded-full shadow-lg hover:bg-blue-600 transform -translate-y-1/2"
            onClick={handlePrevSlide}
          >
            <FaChevronLeft />
          </button>
          <button
            className="absolute top-[50%] right-4 w-10 text-2xl p-2 bg-sky-400 text-white rounded-full shadow-lg hover:bg-blue-600 transform -translate-y-1/2"
      ...
      <div className="mt-12 max-w-7xl mx-auto p-4">
        <h2 className="text-3xl font-bold text-center mb-4 text-gray-800">Shop by Category</h2>
      ...
      {/* Product Section */}
      <div className="mt-8">
        <h2 className="text-3xl font-bold text-center mb-4 text-gray-800">Our Products</h2>
        <p className="text-center text-lg text-gray-500 mb-8">
        ...
        <div className="text-center mt-8">
          <Link
            to="/product"
            className="text-lg font-semibold text-blue-500 hover:underline space-y-5"
          >
            View All Products
          </Link>
        </div>
