...
import { sendOrderConfirmationEmail } from "../components/Core/EmailService"; // Import the email service
...
const Checkout = () => {
  ...
  return (
    <section
      className="Checkout py-10 bg-slate-300 text-richblack-50"
      id="Checkout"
    >
            ...
            <div className="bg-richblack-700 p-8 rounded-lg shadow-lg">
              ...
              <div className="flex justify-center mt-10">
                <button
                  ...
                  className="bg-blue-400 text-white py-3 px-6 rounded-lg font-semibold hover:bg-teal-100 transition duration-300"
                >
                  Purchase
                </button>
              </div>
