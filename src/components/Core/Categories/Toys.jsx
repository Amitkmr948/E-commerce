...
const Toys = () => {
  ...
  const toysProducts = productsData.filter(
    (product) => product && product.category === "Toys" // Defensive check
  );
  ...
  return (
    <div className="bg-slate-200 text-richblack-500 h-full m-auto pt-10">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-center mb-10">Toys</h1>{" "}
        {/* Updated heading */}
        {loading ? (
