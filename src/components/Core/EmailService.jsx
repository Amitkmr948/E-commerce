...
export const sendOrderConfirmationEmail = (emailData) => {
  // Use environment variables for security (best practice)
  const SERVICE_ID = process.env.REACT_APP_EMAILJS_SERVICE_ID || "service_e784ez9"; // Replace with your actual EmailJS service ID
  const TEMPLATE_ID = process.env.REACT_APP_EMAILJS_TEMPLATE_ID || "template_axzl81j"; // Replace with your actual EmailJS template ID
  const PUBLIC_KEY = process.env.REACT_APP_EMAILJS_PUBLIC_KEY || "8p8_l6EGSSHouapnJ"; // Replace with your actual EmailJS public key
